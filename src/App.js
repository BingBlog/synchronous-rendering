...
import AxiosSSEApp from './AxiosSSEApp';
function App() {
  return (
    <div style={containerStyle}>
      <nav style={navStyle}>
        ...
        <Link to="/axios-sse" style={linkStyle}>Axios SSE Demo</Link>
      </nav>
      ...
      <Routes>
        ...
        <Route path="/axios-sse" element={<AxiosSSEApp />} />
        <Route path="/" element={<div style={welcomeStyle}>
          ...
          <ul>
            ...
            <li>Axios SSE - 使用 Axios 的 SSE 演示</li>
          </ul>
        </div>} />
      </Routes>
    </div>
